...
export function makeTurnMarker(turn: number): TurnFeedItem {
  return { id: Math.random().toString(36).slice(2), type: "turn", turn, ts: Date.now() };
}
...
export const SEED_SESSIONS: Session[] = [
  {
    ...
    feed: [
      ...
      { id: "a4", type: "turn", turn: 2, ts: Date.now() - 140000 },
  ...
  },
  {
    ...
    feed: [
      ...
      { id: "b3", type: "turn", turn: 2, ts: Date.now() - 5360000 },
      ...
      { id: "b6", type: "turn", turn: 3, ts: Date.now() - 5300000 },
  ...
  },
  {
    ...
    feed: [
      ...
      { id: "c2", type: "turn", turn: 2, ts: Date.now() - 8970000 },
